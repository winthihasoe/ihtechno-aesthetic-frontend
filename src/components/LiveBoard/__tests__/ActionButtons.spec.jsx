...
describe("ActionButtons", () => {
  ...
  it('shows "Open Pre-treatment" for admin on a preparation visit', () => {
    render(
      <ActionButtons
        visit={mkVisit("preparation")}
        user={adminUser}
        onAction={vi.fn()}
      />,
    );
    expect(
      screen.getByTestId("visit-action-open_preparation"),
    ).toBeInTheDocument();
  });

  it('shows "Mark Done" for reception and sales/marketing on treatment visits', () => {
