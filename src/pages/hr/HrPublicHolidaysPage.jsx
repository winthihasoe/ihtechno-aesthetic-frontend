...
export default function HrPublicHolidaysPage() {
  ...
  return (
    <HrPageShell
      ...
      guide={[
        "The clinic's paid public holidays for the selected year, grouped by month.",
        "Add a holiday with its date and name; holidays affect attendance and leave calculations.",
      ]}
    >
      {showHolidayList ? (
