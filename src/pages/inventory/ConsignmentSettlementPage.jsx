          ...
          <Paper sx={{ p: 2, borderRadius: 2, mb: 2 }}>
            ...
            !ps.is_fully_paid_against_payables ? (
              <Alert severity="warning" variant="outlined" sx={{ mt: 2 }}>
                A supplier payable already overlaps this usage window. You cannot
                post a second one for the same supplier and overlapping dates;
                record the remaining payment on that payable instead.
                {canManagePayables ? (
                  <Box sx={{ mt: 1.5 }}>
                    <Button
                      variant="contained"
