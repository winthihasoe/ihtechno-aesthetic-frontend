...
describe("ConsultationRoomPage", () => {
  ...
  it("renders and saves structured payload", async () => {
    ...
    fireEvent.change(screen.getByLabelText("Diagnosis primary"), { target: { value: "Acne vulgaris" } });
    ...
    expect(screen.getByRole("button", { name: "AI Assist (coming later)" })).toBeDisabled();
  });
});
