...
export default function InventoryPage() {
  ...
  const missingSellingPriceCount = products.filter(
    (p) => p.selling_price == null || p.selling_price === "",
  ).length;
  ...
  return (
    <Box>
      ...
      {missingSellingPriceCount > 0 && (
        ...
        >
          <strong>{missingSellingPriceCount}</strong> product
          {missingSellingPriceCount > 1 ? "s have" : " has"} no selling price.
          Set a price on the product so invoices can prefill — otherwise the
          cashier enters it manually (cost is never used as a fallback).
        </Alert>
      )}
      ...
      >
        <Box
          sx={{
            ...
            gridTemplateColumns: {
              ...
              md: "minmax(200px, 280px) minmax(240px, 320px)",
            },
            gap: 2,
            alignItems: "center",
          }}
        >
          ...
          <ToggleButtonGroup
            ...
            exclusive
            fullWidth
            onChange={(_, v) => v && setDraftStockFilter(v)}
            size="small"
            ...
            <ToggleButton
              ...
              sx={{
                "&.Mui-selected": {
                  ...
                  color: "warning.main",
                  "&:hover": {
                    bgcolor: (t) => alpha(t.palette.warning.main, 0.24),
                  },
                },
              }}
            >
