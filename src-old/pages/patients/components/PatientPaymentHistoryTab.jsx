  ...
  if (!withPayment.length) {
    return (
      <PatientTabEmptyState
        title="No billing records linked to visits yet"
        description="Bills and payment statuses will appear here after checkout or payment posting."
        steps={[
          "Create/complete a visit with billable services.",
          "Generate invoice and post payment from cashier flow.",
          "Return here to review paid/unpaid history by visit.",
        ]}
        previewFields={["Amount", "Payment status", "Paid at", "Visit/Bill reference"]}
      />
    );
  }
