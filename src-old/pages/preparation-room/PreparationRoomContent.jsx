...
export default function PreparationRoomContent({
  visit,
  consultation,
  visitTreatments = [],
  ...
  return (
    <Stack spacing={2}>
      ...
      <VitalSigns
        ...
        editable={canAssign}
        title="Vital Signs"
        subtitle="Update the latest measurements before treatment preparation continues."
      ...
      <Paper variant="outlined" sx={{ p: 1.5, borderRadius: 2 }}>
        ...
        {(consultation?.treatment_plan ||
          ...
          <Typography
            ...
            sx={{ display: "block", mb: 1 }}
          >
            <strong>Treatment selected by doctor:</strong>{" "}
          ...
          <List dense disablePadding sx={{ mb: 1.5 }}>
            {plannedTreatments.map((t) => {
              ...
              return (
                ...
                >
                  <Box sx={{ display: "flex", width: "100%", pr: 6 }}>
                    <ListItemText
      ...
      <Paper variant="outlined" sx={{ p: 2, borderRadius: 2 }}>
        ...
        <Button
          ...
          disabled={promotionSaving}
        >
          {promotionSaving ? "Saving…" : "Save Changes"}
        </Button>
      </Paper>
