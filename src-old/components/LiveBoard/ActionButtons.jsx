...
export default function ActionButtons({
  ...
  if (
    status === "waiting" &&
    canUseLiveboardButton(user, visit, "start_consulting", liveboardRules)
  ) {
    buttons.push(btn("Start Consultation", "start_consultation", null, "info"));
  }

  if (
    status === "waiting" &&
    canUseLiveboardButton(user, visit, "do_not_consulting", liveboardRules)
  ) {
    buttons.push(
      btn(
        "Do not consulting",
  ...
  if (status === "consulting") {
    ...
    if (
      canUseLiveboardButton(user, visit, "send_to_preparation", liveboardRules)
    ) {
      buttons.push(
        btn("Send to Preparation", "send_to_preparation", null, "secondary"),
      );
    }
  }
  ...
  if (status === "preparation") {
    ...
    if (
      canUseLiveboardButton(user, visit, "proceed_treatment", liveboardRules)
    ) {
      buttons.push(
        btn("Proceed to Treatment", "proceed_to_treatment", null, "secondary"),
      );
    }
  }
  ...
  if (
    status === "payment" &&
    canUseLiveboardButton(user, visit, "go_to_invoice", liveboardRules)
  ) {
    buttons.push(
