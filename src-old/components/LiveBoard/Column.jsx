...
export default function Column({
  ...
  const columnBg = alpha(main, theme.palette.mode === "dark" ? 0.18 : 0.1);
  const columnBorder = alpha(main, theme.palette.mode === "dark" ? 0.45 : 0.35);
    ...
    >
      ...
      <Box
        sx={{
          ...
          maxHeight: { xs: "100%", md: "calc(100vh - 260px)" },
        }}
      >
        {visits.length === 0 ? (
          <Typography
