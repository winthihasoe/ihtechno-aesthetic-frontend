...
export default function ConsultingPanel({
  ...
  const sessionFeeFinal = computeConsultationFeeTotal(form);
        ...
        <Stack spacing={1.5}>
                ...
                {savedFormResponses.map((row) => (
                  <ListItem key={row.id} divider>
                    <ListItemText
                      ...
                      secondary={`Saved: ${formatLiveboardRelativeTime(
            ...
            {plannedTreatments.length > 0 ? (
              ...
              >
                {plannedTreatments.map((t) => {
                  ...
                  return (
                    <ListItem key={t.id} divider sx={{ py: 0.75, flexDirection: "column", alignItems: "stretch" }}>
                      <ListItemText
                        ...
                        secondaryTypographyProps={{ variant: "caption" }}
                      />
                      <TreatmentStockWarningAlert treatment={t} dense sx={{ mt: 0.75 }} />
                    </ListItem>
                  );
                })}
              </List>
          ...
          <Paper variant="outlined" sx={{ p: 1.5, borderRadius: 2 }}>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ display: "block", mb: 1 }}>
              ...
              move to preparation or treatment, earlier photos appear as reference so the team avoids
              duplicate intake.
            </Typography>
            {photosLoading ? (
              <Typography variant="caption" color="text.secondary">
          ...
          <Paper variant="outlined" sx={{ p: 1.5, borderRadius: 2 }}>
            ...
            <Typography variant="body2">
              <strong>Apply fee:</strong> {form.session_fee_enabled ? "Yes" : "No (FOC)"}
            </Typography>
            <Typography variant="body2">
            ...
            <Typography variant="caption" color="text.secondary" sx={{ display: "block", mt: 1 }}>
              Invoice total: {form.session_fee_enabled ? formatKyats(sessionFeeFinal) : "FOC (0 K)"}
            </Typography>
          </Paper>
        </Stack>
