...
export const updateVisitVitalSigns = async (visitId, payload) => {
...
export const unlockConsultation = async (id) => {
  const { data } = await apiClient.post(`/consultations/${id}/unlock`);
  return data;
};
