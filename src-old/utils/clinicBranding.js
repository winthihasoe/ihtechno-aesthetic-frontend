...
/** Bundled clinic mark in `public/logo.jpg` when no custom logo is configured. */
export const DEFAULT_LOGO_URL = "/logo.jpg";

/** Black-and-white logo for invoice / voucher print (`public/invoice-logo.png`). */
export const INVOICE_PRINT_LOGO_URL = "/invoice-logo.png";

export function getClinicLogoUrl(settings) {
